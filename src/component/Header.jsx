		...
		<section className="container mx-auto md:px-20 pt-10 text-white">
			...
			<main className=" mx-12 my-4">
				<h2
					data-aos="fade-down"
					data-aos-delay="300"
					className="text-8xl md:text-[160px] xl:text-[190px] w-fit mx-auto text-gray-300   font-extrabold">
					Welcome
				</h2>
            ...
            text-3xl md:text-5xl xl:text-7xl font-bold">
						...
						<p
							data-aos="fade-up"
							className="text-3xl md:text-4xl font-extralight leading-9 tracking-tight  md:pt-20">
					...
					<div
						data-aos="zoom-in"
						data-aos-delay="500"
						className="md:flex hidden xl:md:-mt-40 -z-20 justify-center">
						<img
							className="h-[100vh] "
							src={B}
							alt=""
